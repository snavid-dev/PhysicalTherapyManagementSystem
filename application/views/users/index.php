                ...
                <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-4">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('image') ?> <span class="text-red">*</span></label>
                              <input type="file" id="inputImage" class="form-control">
                              <input type="hidden" id="inputImageHiddenInput" name="uploadedImage" class="form-control">
                              <!-- <input type="file" name="upload_image" id="upload_image" style="background-color: blue" /> -->
                              <!-- TODO: here is the real input -->
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('lname') ?> <span class="text-red">*</span></label>
                              <input type="text" name="lname" class="form-control" placeholder="<?= $ci->lang('lname') ?>">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('username') ?> <span class="text-red">*</span></label>
                              <input type="text" name="username" class="form-control" placeholder="<?= $ci->lang('username') ?>" autocomplete="username">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('account type') ?> <span class="text-red">*</span></label>
                              <select class="form-control form-select" name="role" data-bs-placeholder="Select" tabindex="-1" aria-hidden="true">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('status') ?> <span class="text-red">*</span></label>
                              <select name="status" class="form-control form-select">
                                <option value="A" selected><?= $ci->lang('accepted') ?></option>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('password') ?> <span class="text-red">*</span></label>
                              <input type="password" name="password" class="form-control" placeholder="<?= $ci->lang('password') ?>" autocomplete="off">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label"><?= $ci->lang('confirm password') ?> <span class="text-red">*</span></label>
                              <input type="password" name="confirm" class="form-control" placeholder="<?= $ci->lang('confirm password') ?>" autocomplete="off">
                            </div>
                          </div>
                        </div>
                      </form>
                    ...
                    <div class="modal-footer">
                      ...
                      <button class="btn btn-primary" onclick="xhrSubmitMultiTable('insert_user', '<?= base_url('admin/insert_user') ?>', 'file-datatable', 'extralargemodal')"><?= $ci->lang('save') ?> <i class="fa fa-plus"></i> </button>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <td>
                      <div class="g-2">
                        <?php if (ucfirst($user['status']) == 'A') : ?>
                          ...
                          <a href="javascript:xhrChangeStatusUsers('<?= base_url('admin/change_status_user/') ?>', '<?= $user['id'] ?>', 'P')" class="btn btn-icon btn-outline-primary rounded-pill btn-wave waves-effect waves-light"><span class="fa fa-minus-circle fs-14"></span></a>
                        <?php else : ?>
                          <a href="javascript:xhrChangeStatusUsers('<?= base_url('admin/change_status_user/') ?>', '<?= $user['id'] ?>', 'A')" class="btn btn-icon btn-outline-primary rounded-pill btn-wave waves-effect waves-light"><span class="fa fa-unlock fs-14"></span></a>
                        <?php endif; ?>
                        <a href="javascript:delete_via_alert('<?= $user['id'] ?>', '<?= base_url() ?>admin/delete_user', 'file-datatable', null, true)" class="btn btn-icon btn-outline-danger rounded-pill btn-wave waves-effect waves-light" data-bs-toggle="tooltip" data-bs-original-title="<?= $ci->lang('delete') ?>"><span class="fa fa-trash fs-14"></span></a>
                      </div>
                    </td>
                  </tr>
                <?php $i++;
