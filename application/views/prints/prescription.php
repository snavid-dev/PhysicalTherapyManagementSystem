...
<head>
    ...
    <style>
        @font-face {
            font-family: "b_yekan";
            src: url("<?= $ci->dentist->assets_url() ?>assets/fonts/Yekan.ttf");
        }
        ...
        .info {
            ...
            background-image: url('<?= $ci->dentist->assets_url() ?>assets/images/DPCMYK@1x_1------x.jpg');
