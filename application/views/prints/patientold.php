...
<!--                                                            <tr>-->
<!--                                                                <td>--><?php //= $i ?><!--</td>-->
<!--                                                                <td>--><?php //= $tooth['name'] ?><!--</td>-->
<!--                                                                <td>--><?php //= $ci->dentist->find_location($tooth['location']) ?><!--</td>-->
<!--                                                                <td>--><?php //= $ci->services_name($tooth['services'])  ?><!--</td>-->
<!--                                                                <td>--><?php //= $tooth['price'] ?><!--</td>-->
<!--                                                                <td>--><?php //= $tooth['details'] ?><!--</td>-->
<!--                                                            </tr>-->
<!--                                                        --><?php //$i++;
//                                                            $fee += $tooth['price'];
//                                                        endforeach; ?>
...
<!--                                                            <td style="font-size: 0.9rem">--><?php //= $fee ?><!--</td>-->
<!--                                                            <td style="font-size: 0.8rem"></td>-->
<!--                                                        </tr>-->
<!--                                                    </tfoot>-->
<!--                                                </table>-->
