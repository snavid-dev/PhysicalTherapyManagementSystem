										...
										<div class="element-box">
											...
											<table>
												<tbody style="font-size: 0.8rem">
													<tr>
														<td>لابراتوار مربوطه</td>
														<td><?= $single['lab_name'] ?></td>
													</tr>
													<tr>
														<td>سریال نمبر</td>
													...
													<tr>
														<td>نام مریض</td>
														<td><?= $ci->mylibrary->get_patient_name($single['name'], $single['lname'], '', $single['gender']) ?></td>
													</tr>
													<tr>
														<td>دندان ها</td>
													...
													<tr>
														<td>نوعیت دندان ها</td>
														<td><?= substr($typesName, 0, -1) ?></td>
													</tr>
													<tr>
														<td>رنگ دندان ها</td>
														<td class="english"><?= $single['color'] ?></td>
													</tr>
													<?php if (!empty($single['unit'])) : ?>
														<tr>
															<td>تعداد واحد ها</td>
															<td><bdo dir="ltr"><?= $single['unit'] ?></bdo></td>
														</tr>
													<?php endif; ?>
													<tr>
														<td>تاریخ تحویل گیری</td>
														<td><bdo dir="ltr"><?= $single['give_date'] ?></bdo></td>
													</tr>
													<tr>
													...
													<?php if (!empty($single['remarks'])) : ?>
														<tr style="font-size: 0.9rem; border: solid 3px;">
															<td class="borderless text-center" colspan="2"><?= $single['remarks'] ?></td>
														</tr>

													<?php endif; ?>

													<tr style="font-size: 0.9rem; border: solid 3px;">
														<td class="borderless text-center">مصارف پرداختی</td>
														<td class="borderless text-center"><?= $single['dr'] ?> ؋</td>
													</tr>

												</tbody>
											</table>

											<div class="company-extra text-center" style="font-size: 0.8rem; font-weight: 700;margin-top: 10px;"><sup>*</sup>برای جلوگیری از سرگردانی مریضان لطف نموده در قسمت تاریخ تحویل گیری توجه داشته باشید<sup>*</sup></div>
