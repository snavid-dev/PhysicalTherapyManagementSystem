				...
				<div class="infos">
					<div class="info-1">
						<!-- <div class="company-name">
								<img src="<?= $ci->dentist->assets_url() ?>assets/img/logo.jpg" width="100px">
							</div> -->
						<div class="company-name">
								...
								<div class="element-wrapper">
									<div class="element-box">
										...
										<table>
											...
											<tr>
												<td>حساب مالی</td>
												<td><?= $single['name'] . ' ' . $single['lname'] ?></td>
											</tr>
											<tr>
												<td>نوعیت</td>
												<td><?= (!is_null($single['cr']) || $single['cr'] != 0) ? 'پرداخت' : 'برداشت' ?></td>
											</tr>
											<tr>
												<td>مقدار</td>
												<td><?= (!is_null($single['cr']) || $single['cr'] != 0) ? $single['cr'] : $single['dr'] ?>
													؋
												</td>
											</tr>
											...
											<tr>
												<td>تاریخ</td>
												<td><bdo dir="ltr"><?= $single['shamsi'] ?></bdo></td>
											</tr>
											...
											<tr>
												<td class="borderless" style="padding: 15px">محل امضاء:</td>
										...
										<div class="company-extra text-center"
											 style="font-size: 0.6rem; font-weight: 700;margin-top: 10px;"
											 id="qrcode"></div>
										<div class="company-extra text-center"
											 style="font-size: 0.6rem; font-weight: 700;margin-top: 10px;">نرم افزار
											مدیریت کلینیک دندان(Canin)
										</div>
									</div>
								</div>
							</div>
