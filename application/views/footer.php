    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content country-select-modal">
            <div class="modal-header">
                <h6 class="modal-title"><?= $ci->lang('choose language') ?></h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <ul class="row p-3">
                    <li class="col-lg-4 mb-2">
                        <a href="<?= base_url('admin/language/fa') ?>" class="btn btn-country btn-lg btn-block <?= ($_COOKIE['language'] == 'fa') ? 'active' : '' ?> fa">
                            <span class="country-selector"><img alt="" src="<?= $ci->dentist->assets_url() ?>assets/images/flags-img/afg.png" class="me-3 language"></span>فارسی
                        </a>
                    </li>
                    <li class="col-lg-4 mb-2">
                        <a href="<?= base_url('admin/language/en') ?>" class="btn btn-country btn-lg btn-block <?= ($_COOKIE['language'] == 'en') ? 'active' : '' ?> en">
                            <span class="country-selector"><img alt="" src="<?= $ci->dentist->assets_url() ?>assets/images/flags-img/usa.png" class="me-3 language"></span>English
                        </a>
                    </li>

                    <li class="col-lg-4 mb-2">
                        <a href="<?= base_url('admin/language/pa') ?>" class="btn btn-country btn-lg btn-block <?= ($_COOKIE['language'] == 'pa') ? 'active' : '' ?> pa">
                            <span class="country-selector"><img alt="" src="<?= $ci->dentist->assets_url() ?>assets/images/flags-img/afg.png" class="me-3 language"></span>پښتو
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label"><?= $ci->lang('old password') ?> <span class="text-red">*</span></label>
                                <input type="password" name="oldPassword" class="form-control" placeholder="<?= $ci->lang('old password') ?>">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label"><?= $ci->lang('new password') ?> <span class="text-red">*</span></label>
                                <input type="password" name="newPassword" class="form-control" placeholder="<?= $ci->lang('new password') ?>">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label"><?= $ci->lang('confirm new password') ?> <span class="text-red">*</span></label>
                                <input type="password" name="confirmPassword" class="form-control" placeholder="<?= $ci->lang('confirm new password') ?>">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="xhrChangePassword('modify_password_form', '<?= base_url() ?>admin/update_password', 'modify_password')"><?= $ci->lang('update') ?> <i class="fa fa-lock"></i></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 text-center">
                ...
                کپی رایت © <span>2022 - <?= date('Y') ?></span> <a href="https://cyborgtech.co/" target="_blank"> سایبورگ تک</a>. دیزاین شده با <span class="fa fa-heart text-danger"></span> توسط <a href="https://cyborgtech.co/" target="_blank"> تیم خلاق ما </a>
            </div>
        </div>
    </div>
</footer>
...
<script src="<?= $ci->dentist->assets_url() ?>assets/plugins/accordion-Wizard-Form/jquery.accordion-wizard.min.js"></script>
...
<script type="text/javascript" src="<?= $ci->dentist->assets_url() ?>/assets/plugins/jalalidatepicker/jalalidatepicker.min.js"></script>
