              ...
              <tbody>
                ...
                foreach ($users as $user) : ?>
                  <tr id="<?= $user['id'] ?>">
                    ...
                    <td><?= $user['lname'] ?></td>
                    <td><?= $user['username'] ?></td>
                    <td><span class="badge <?= (ucfirst($user['status']) == 'A') ? 'bg-success-transparent text-success' : 'bg-danger-transparent text-danger' ?> rounded-pill  p-2 px-3"><?= $ci->mylibrary->check_status($user['status']) ?></span></td>
                    ...
                    <td>
                      <div class="g-2">
                        ...
                        <?php else : ?>
                          <a class="btn btn-icon btn-outline-primary rounded-pill btn-wave waves-effect waves-light"><span class="fa fa-unlock fs-14"></span></a>
                        <?php endif; ?>
