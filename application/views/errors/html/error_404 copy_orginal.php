...
<head>
    ...
    <!-- TITLE -->
    <title>CyborgTech – Bootstrap 5 Admin & Dashboard Template</title>
...
<body class="login-img">
                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <h5 class="error-details">
                            <?= $ci->language->languages('404 error', 'fa') ?>
                        </h5>
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5 mb-5" href="<?= base_url()?>"> <i class="fa fa-long-arrow-left"></i> <?= $ci->language->languages('back to home', 'fa') ?> </a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Custom-switcher -->
    <script src="<?= base_url() ?>/assets/js/custom-swicher.js"></script>
