          ...
          <div class="tabs-menu1">
            ...
            <ul class="nav panel-tabs product-sale" role="tablist">
              ...
              <li style="width: 150px;">
                <input data-jdp type="text" class="form-control" id="datePicker" onchange="tableFilter(this.value)" placeholder="<?= $ci->lang('date') ?>">
              </li>
              ...
              <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-3">
                          <div class="form-group">
                            ...
                            <select name="patient_id" class="form-control select2-show-search form-select" data-placeholder="<?= $ci->lang('select') ?>" id="patientName" onchange="check_turns()">
                        ...
                        <div class="col-sm-12 col-md-3">
                          <div class="form-group jdp" id="main-div">
                            ...
                            <input data-jdp type="text" id="test-date-id-date" name="date" value="<?= $ci->mylibrary->getCurrentShamsiDate()['date'] ?>" class="form-control" placeholder="<?= $ci->lang('date') ?>" onchange="check_turns()">
                            <div></div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-3">
                          <div class="form-group">
                            ...
                            <select name="doctor_id" class="form-control select2-show-search form-select" data-placeholder="<?= $ci->lang('select') ?>" id="doctorName" onchange="check_turns()">
                              <option label="<?= $ci->lang('select') ?>"></option>
                              <option value="all">
                                <?= $ci->lang("select") ?>
                              </option>
                        ...
                        <div class="col-sm-12 col-md-3">
                          <div class="form-group">
                            ...
                            <select name="hour" class="form-control select2-show-search form-select" data-placeholder="<?= $ci->lang('select') ?>" id="patientTime" onchange="check_turns()">
                              <option label="<?= $ci->lang('select') ?>"></option>
                  ...
                  <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" onclick="xhrSubmit('insertAccount', '<?= base_url() ?>admin/insert_turn')">
                ...
                <tr id="<?= $receipt['id'] ?>">
                  ...
                  <td>
                    <div class="g-2">
                      ...
                      <a href="javascript:print_turn('<?= $receipt['id'] ?>', '<?= base_url() ?>admin/delete_turn')" class="btn btn-icon btn-outline-warning rounded-pill btn-wave waves-effect waves-light"><span class="fe fe-printer fs-14"></span></a>
