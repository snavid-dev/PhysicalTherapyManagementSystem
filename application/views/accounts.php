				...
				<div class="table-responsive">
					<table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
						...
						<tr>
							...
							<?php if ($ci->auth->has_permission('Update Account') || $ci->auth->has_permission('Delete Account')): ?>
						...
						foreach ($accounts as $account) : ?>
							<tr id="<?= $account['id'] ?>">
								...
								<?php if ($ci->auth->has_permission('Update Account') || $ci->auth->has_permission('Delete Account')): ?>
									<td>
										<div class="g-2">
											<?php if ($ci->auth->has_permission('Update Account')): ?>
												<a href="javascript:edit_account('<?= $account['id'] ?>')"
											...
											<?php if ($ci->auth->has_permission('Delete Account')): ?>
												<a href="javascript:delete_via_alert('<?= $account['id'] ?>', '<?= base_url() ?>admin/delete_account')"
