						...
						<ul class="nav panel-tabs product-sale" role="tablist">
							...
							<li style="width: 150px;">
								<input data-jdp type="text" class="form-control" id="datePicker"
									   onchange="tableFilterPhoneBook(this.value)"
								...
								<div class="modal-content">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-12">
													<div class="form-group">
														<label
															class="form-label"><?= $ci->lang('Call Failure Reason') ?></label>
														<textarea type="text" name="remarks" id="callDetails1"
									...
									<div class="modal-footer">
										...
										<button class="btn btn-primary"
												onclick="xhrUpdate('failedCallForm', '<?= base_url() ?>admin/failedCall', 'callmodal')">
											<?= $ci->lang('Submit') ?>
										</button>
									</div>
								</div>
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="eyedate" id="eyedate"
															   class="form-control">
													</div>
												</div>
												...
												<div class="col-sm-12 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="eyehour" id="eyehour"
															   class="form-control">
													</div>
												</div>
												...
												<div class="col-sm-12 col-md-12">
													<div class="form-group">
														<label
															class="form-label"><?= $ci->lang('Call Failure Reason') ?></label>
														<textarea type="text" name="remarks" id="eyeremark"
																  class="form-control" rows="4"
																  placeholder="<?= $ci->lang('desc') ?>"></textarea>
													</div>
												</div>
								...
								<td>
									<div class="g-2">
										...
										<?php if (empty($receipt['date_phone1'])) { ?>
											<a href="javascript:callModal('<?= $receipt['id'] ?>', 'call1')"
											   class="btn btn-icon btn-outline-success rounded-pill btn-wave waves-effect waves-light"><span
													class="fa fa-phone fs-14"></span></a>
											<a href="javascript:callModal('<?= $receipt['id'] ?>', 'call2')"
											   class="btn btn-icon btn-outline-secondary rounded-pill btn-wave waves-effect waves-light disabled"><span
													class="fa fa-phone fs-14"></span></a>
											<a href="javascript:callModal('<?= $receipt['id'] ?>', 'call3')"
											   class="btn btn-icon btn-outline-danger rounded-pill btn-wave waves-effect waves-light disabled"><span
													class="fa fa-phone fs-14"></span></a>

										<?php } elseif (empty($receipt['date_phone2'])) { ?>
											<a href="javascript:eye('<?= $receipt['id'] ?>', 'call1')"
											   class="btn btn-icon btn-outline-success rounded-pill btn-wave waves-effect waves-light"><span
										...
										<?php } elseif (empty($receipt['date_phone2'])) { ?>
											<a href="javascript:eye('<?= $receipt['id'] ?>', 'call1')"
											   class="btn btn-icon btn-outline-success rounded-pill btn-wave waves-effect waves-light"><span
													class="fa fa-eye fs-14"></span></a>
											<a href="javascript:eye('<?= $receipt['id'] ?>', 'call2')"
											   class="btn btn-icon btn-outline-secondary rounded-pill btn-wave waves-effect waves-light"><span
													class="fa fa-eye fs-14"></span></a>
											<a href="javascript:callModal('<?= $receipt['id'] ?>', 'call3')"
										...
										<?php } else { ?>
											...
											<a href="javascript:eye('<?= $receipt['id'] ?>', 'call2')"
											   class="btn btn-icon btn-outline-secondary rounded-pill btn-wave waves-effect waves-light"><span
													class="fa fa-eye fs-14"></span></a>
											<a href="javascript:eye('<?= $receipt['id'] ?>', 'call3')"
											   class="btn btn-icon btn-outline-danger rounded-pill btn-wave waves-effect waves-light"><span
													class="fa fa-eye fs-14"></span></a>
