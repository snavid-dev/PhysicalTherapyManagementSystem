...
<div class="modal fade effect-scale" tabindex="-1" id="teethmodal_baby" role="dialog">
	...
	<?php $ci->render("patients/components/main/modals/baby/insert/sidebar/sidebar.php");  ?>
...
<!--					--><?php //= $ci->lang('Insert Tooth') ?>
				...
				<form id="demo_form_baby" style="width: 75%; display: inline-flex; align-items: center;">
			...
			<div class="border-block-end-dashed  bg-white rounded-2 p-2">
				<div>
					<ul class="nav nav-pills nav-justified gx-3 tab-style-6 d-sm-flex d-block " id="insertTabs_baby"
						role="tablist">
						<li class="nav-item rounded" role="presentation">
							<button class="nav-link active" id="Restorative_baby" data-bs-toggle="tab"
								data-bs-target="#Restorative-pane_baby" type="button" role="tab"
								aria-controls="Restorative-pane_baby" aria-selected="true"><i
									class="fa fa-tooth me-1 align-middle d-inline-block fs-16"></i><?= $ci->lang('restorative') ?>
							</button> <!--Translate-->
						</li>
						<li class="nav-item rounded" role="presentation">
							<button class="nav-link" id="endo_baby" data-bs-toggle="tab" data-bs-target="#endo-pane_baby"
								type="button" role="tab" aria-controls="endo-pane_baby" aria-selected="false"><i
									class="fa fa-user-friends me-1 align-middle d-inline-block fs-16"></i><?= $ci->lang('Endodantic') ?>
							</button> <!--Translate-->
						</li>
						<li class="nav-item rounded" role="presentation">
							<button class="nav-link" id="pros-tab_baby" data-bs-toggle="tab" data-bs-target="#pros-pane_baby"
								type="button" role="tab" aria-controls="pros-pane_baby" aria-selected="false"><i
			...
			<!-- insTabContent start -->
			<div class="tab-content" id="myITabContent_baby">

				<!--TODO:insFixing  -->
				<!--insFixing  -->
				<?php $ci->render("patients/components/main/modals/baby/insert/restorative/restorative.php");  ?>


				<!-- TODO:insEndo -->
				<?php $ci->render("patients/components/main/modals/baby/insert/endo/endo.php");  ?>

				<!-- insEndo -->


				<!-- TODO:insPro -->
				<?php $ci->render("patients/components/main/modals/baby/insert/pro/pro.php");  ?>
