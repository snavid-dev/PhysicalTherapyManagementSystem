	...
	<div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
		...
		<div class="modal-content">
			...
			<!-- TODO: ask :demo_form -->
				<form id="demo_form" style="width: 75%; display: inline-flex; align-items: center;">
					...
					<div style="width: 500px;display: flex;gap: 10px;">
						...
						<!-- TODO: ask : onchange="multiple_value('#select_diagnose', '#diagnose_adult')" id="select_diagnose"-->
			...
			<div class="modal-footer">
				...
				<!-- TODO: ask :onclick="submitWithoutDatatableMulti(['insertTooth', 'demo_form', 'insertFixing', 'insertPro', 'checkboxes'], '<?= base_url() ?>admin/insert_tooth', '','teethmodal', list_teeth)">  what should I do with teethmodal on the below function -->
