...
$route['store/view_product/(:num)'] = 'Store/view_product/$1';
...
$route['store/view_requisition/(:num)'] = 'Store/view_requisition/$1';
...
$route['store/edit_sale/(:num)'] = 'Store/edit_sale/$1';
$route['store/update_sale/(:num)'] = 'Store/update_sale/$1';
$route['store/delete_sale/(:num)'] = 'Store/delete_sale/$1';
...
$route['store/view_sale_batch/(:num)'] = 'Store/view_sale_batch/$1';
