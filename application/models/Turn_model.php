...
class Turn_model extends CI_Model
{
	...
	protected function ensure_turn_columns()
	{
		...
		$this->add_column_if_missing('turns', 'payment_type', "ALTER TABLE `turns` ADD COLUMN `payment_type` enum('prepaid','cash','deferred','free') NOT NULL DEFAULT 'cash' AFTER `fee`");
