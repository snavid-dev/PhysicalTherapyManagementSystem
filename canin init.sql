...
--
-- Host: localhost
-- Generation Time: Apr 21, 2025 at 09:28 PM
...
--
-- Dumping data for table `doctor_leave`
--
...
--
-- Dumping data for table `endo_has_basic_information_teeth`
--
...
--
-- Dumping data for table `endo_has_services`
--
...
(
	...
	`install_time`        varchar(100)         DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
VALUES (9, 'Amoxicilin', 'Cap', '500', '1', '3', '10', '', 'mg'),
	   ...
	   (39, 'falgyl', 'Syr', '100', '1', '3', '6', 'IV', 'mg'),
	   (40, 'Fresh Maouth', 'Solution', '', '1', '3', '', '', 'Bottle'),
	   (41, 'Protect', 'Solution', '100', '1', '3', '1', 'ORAL', 'mg'),
	   (42, 'H2O2', 'Solution', '00', '1', '3', '', 'ORAL', 'mg');
...
VALUES (1, 'Create Patient', 1, '2024-11-17 11:18:16'),
	   ...
	   (7, 'Update Patient Pending', 1, '2024-11-17 11:18:16'),
	   (8, 'Update Personal Information', 1, '2024-11-17 11:18:16'),
	   (9, 'Delete Teeth', 1, '2024-11-17 11:18:16'),
	   (10, 'Delete Personal Turn', 2, '2024-11-17 11:18:16'),
	   ...
	   (31, 'Read Today Balance', 3, '2024-11-17 11:18:16'),
	   ...
	   (74, 'Update Teeth', 1, '2024-11-17 11:18:16'),
	   (75, 'View Phone Numbers', 1, '2024-11-17 11:18:16'),
	   (76, 'Personal Payment Status', 1, '2024-11-17 11:18:16'),
	   (77, 'Personal Treatment Status', 1, '2024-11-17 11:18:16'),
	   (78, 'View Accounts', 3, '2024-11-17 11:18:16'),
	   (79, 'View Receipts', 3, '2024-11-17 11:18:16');
...
--
-- Table structure for table `prescription_samples`
--

CREATE TABLE `prescription_samples`
(
	`id`           int(11) NOT NULL,
	`medicine_1`   int(11) DEFAULT NULL,
	`usageType_1`  varchar(45)           DEFAULT NULL,
...
--
-- Dumping data for table `prescription_samples`
--
...
--
-- Dumping data for table `prosthodontics`
--
...
--
-- Dumping data for table `prosthodontics_has_basic_information_teeth`
--
...
--
-- Dumping data for table `prosthodontics_has_services`
--
...
--
-- Dumping data for table `restorative`
--
...
--
-- Dumping data for table `restorative_has_basic_information_teeth`
--
...
--
-- Dumping data for table `restorative_has_services`
--
...
VALUES (1, 'Admin', '2024-11-20 00:37:04');
...
--
-- Dumping data for table `tooth_has_diagnose`
--
...
(
	...
	`out_time`       varchar(45)          DEFAULT NULL,
	`exam_time`      varchar(45)          DEFAULT NULL,
	`paid_user_id`   int(11) DEFAULT NULL,
...
--
-- Table structure for table `turn_tooth_done`
--

CREATE TABLE `turn_tooth_done`
(
	`id`           int(11) NOT NULL,
...
--
-- Dumping data for table `turn_tooth_done`
--
...
--
-- Table structure for table `turn_tooth_recommended`
--

CREATE TABLE `turn_tooth_recommended`
(
	`id`           int(11) NOT NULL,
...
--
-- Dumping data for table `turn_tooth_recommended`
--
...
INSERT INTO `users` (`id`, `fname`, `lname`, `role`, `username`, `status`, `password`, `photo`, `uniqid`, `role_id`,
					 `working_start_time`, `working_end_time`)
VALUES (1, 'سید نوید', 'عظیمی', 'A', 'Navid', 'A', 'b8a1ebd0836b58bca6fe44de5f2ac969', 'default.png', 'adfads6456', 1,
		'', '');
...
--
-- Indexes for table `prescription_samples`
--
ALTER TABLE `prescription_samples`
	ADD PRIMARY KEY (`id`),
  ADD KEY `fk_prescription_sample_users1_idx` (`users_id`);
...
ALTER TABLE `turn`
  ...
  ADD KEY `fk_turn_users1_idx` (`doctor_id`),
  ADD KEY `fk_turn_users2` (`paid_user_id`);

--
-- Indexes for table `turn_tooth_done`
--
ALTER TABLE `turn_tooth_done`
	ADD PRIMARY KEY (`id`),
  ADD KEY `turn_id` (`turn_id`),
  ADD KEY `process_id` (`process_id`);

--
-- Indexes for table `turn_tooth_recommended`
--
ALTER TABLE `turn_tooth_recommended`
	ADD PRIMARY KEY (`id`),
  ADD KEY `turn_id` (`turn_id`),
  ADD KEY `process_id` (`process_id`);
...
--
-- AUTO_INCREMENT for table `prescription_samples`
--
ALTER TABLE `prescription_samples`
...
--
ALTER TABLE `tooth`
	MODIFY `id` int (10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2433;
...
--
-- AUTO_INCREMENT for table `turn_tooth_done`
--
ALTER TABLE `turn_tooth_done`
	MODIFY `id` int (11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=517;

--
-- AUTO_INCREMENT for table `turn_tooth_recommended`
--
ALTER TABLE `turn_tooth_recommended`
...
--
ALTER TABLE `processes`
	ADD CONSTRAINT `processes_ibfk_1` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
NO ACTION ON
UPDATE NO ACTION,
	ADD CONSTRAINT `fk_turn_users2` FOREIGN KEY (`paid_user_id`) REFERENCES `users` (`id`);

--
-- Constraints for table `turn_tooth_done`
--
ALTER TABLE `turn_tooth_done`
	ADD CONSTRAINT `turn_tooth_done_ibfk_1` FOREIGN KEY (`turn_id`) REFERENCES `turn` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `turn_tooth_done_ibfk_2` FOREIGN KEY (`process_id`) REFERENCES `processes` (`id`) ON
DELETE
SET NULL;

--
-- Constraints for table `turn_tooth_recommended`
--
ALTER TABLE `turn_tooth_recommended`
	ADD CONSTRAINT `turn_tooth_recommended_ibfk_2` FOREIGN KEY (`process_id`) REFERENCES `processes` (`id`) ON DELETE SET NULL;
...
CASCADE ON
UPDATE CASCADE,
	ADD CONSTRAINT `fk_waiting_room_temp_turn1` FOREIGN KEY (`temp_turn_id`) REFERENCES `temp_turn` (`id`)
ON
DELETE
CASCADE ON
UPDATE CASCADE,
	ADD CONSTRAINT `fk_waiting_room_turn1` FOREIGN KEY (`turn_id`) REFERENCES `turn` (`id`)
ON
DELETE
CASCADE ON
UPDATE CASCADE;
