...
INSERT INTO `basic_information_teeth` (`id`, `name`, `department`, `categories_id`) VALUES
(1, 'Composite', 'restorative', 3),
...
INSERT INTO `diagnose` (`id`, `name`) VALUES
(1, 'Dental Caries'),
...
INSERT INTO `medicine` (`id`, `name`, `type`, `doze`, `day`, `times`, `amount`, `usageType`, `unit`) VALUES
(9, 'Amoxicilin', 'Cap', '500', '1', '3', '10', '', 'mg'),
...
INSERT INTO `permissions` (`id`, `permission_name`, `category_id`, `created_at`) VALUES
(1, 'Create Patient', 1, '2024-11-17 11:18:16'),
...
INSERT INTO `permission_categories` (`id`, `category_name`, `created_at`) VALUES
(1, 'Patient Management', '2024-11-17 11:15:13'),
...
ALTER TABLE `endo_has_basic_information_teeth`
  ...
  ADD CONSTRAINT `fk_endo_has_basic_information_teeth_endo1` FOREIGN KEY (`endo_id`) REFERENCES `endo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `endo_has_services`
  ...
  ADD CONSTRAINT `fk_endo_has_services_services1` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `prosthodontics_has_basic_information_teeth`
  ...
  ADD CONSTRAINT `fk_Prosthodontics_has_basic_information_teeth_basic_informati1` FOREIGN KEY (`basic_information_teeth_id`) REFERENCES `basic_information_teeth` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `prosthodontics_has_services`
  ...
  ADD CONSTRAINT `fk_Prosthodontics_has_services_services1` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `restorative_has_basic_information_teeth`
  ...
  ADD CONSTRAINT `fk_restorative_has_basic_information_teeth_restorative1` FOREIGN KEY (`restorative_id`) REFERENCES `restorative` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `restorative_has_services`
  ...
  ADD CONSTRAINT `fk_restorative_has_services_services1` FOREIGN KEY (`services_id`) REFERENCES `services` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `temp_patient`
  ...
  ADD CONSTRAINT `fk_temp_patient_users2` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `temp_turn`
  ...
  ADD CONSTRAINT `fk_turn_users10` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `tooth`
  ...
  ADD CONSTRAINT `fk_tooth_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `tooth_has_diagnose`
  ...
  ADD CONSTRAINT `fk_tooth_has_diagnose_tooth1` FOREIGN KEY (`tooth_id`) REFERENCES `tooth` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `waiting_room`
  ...
  ADD CONSTRAINT `fk_waiting_room_temp_patient1` FOREIGN KEY (`temp_patient_id`) REFERENCES `temp_patient` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_waiting_room_temp_turn1` FOREIGN KEY (`temp_turn_id`) REFERENCES `temp_turn` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_waiting_room_turn1` FOREIGN KEY (`turn_id`) REFERENCES `turn` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
